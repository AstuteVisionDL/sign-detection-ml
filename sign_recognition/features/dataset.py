...
class RTSDDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        fifty_one_dataset = fo.Dataset.from_dir(
...
if __name__ == "__main__":
    ...
    rtsd_dataset = RTSDDataset(data_dir, train=False, transforms=test_transforms, fast_dev_run=True)
    print(rtsd_dataset[0])
    data_loader = torch.utils.data.DataLoader(
        rtsd_dataset, batch_size=2, shuffle=True, num_workers=0,
